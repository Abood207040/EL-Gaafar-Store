-- Phase 5: POS Architecture Updates
-- Run this in the Supabase SQL Editor

-- 1. ADD NEW COLUMNS TO OFFLINE SALES
...
-- 2. UPDATE RPC TO HANDLE DISCOUNTS AND NEW COLUMNS
...
BEGIN
    ...
    INSERT INTO public.offline_sales (
        sale_number, staff_id, customer_id, subtotal, discount, tax, total, payment_method, amount_received, change_amount
    ) VALUES (
        v_sale_number, auth.uid(), p_customer_id, 0, p_discount, 0, 0, p_payment_method, p_amount_received, p_change_amount
    )
